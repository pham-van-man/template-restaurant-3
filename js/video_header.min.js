        ...
        o(window)
          .resize(function () {
            var e = o(window).width(),
              i = o(window).height();
            r.container.width(e).height(e * r.container.data("aspectRatio")),
              i < r.container.height() && r.container.width(e).height(i);
          })
          .trigger("resize");
    },
    d = function () {
      ...
      r.header.hide(),
        r.container.append(
          (function () {
            ...
            else if ("vimeo" === videoDetails.provider)
              e =
            ...
            else if ("html5" === videoDetails.provider)
              e =
